...
function verify() {
    ...
    if (mystring >= 621 && mystring <= 799) {
        ...
        var textnode = document.createTextNode("   Jio,Maharashtra");
        ...
        var node = document.createElement("b");
        var textnode = document.createTextNode("   Idea,Maharashtra");
        node.appendChild(textnode);
        document.getElementById('mob').appendChild(node);
        ...
        var node = document.createElement("b");
        var textnode = document.createTextNode("   Vodafone,Maharashtra");
        node.appendChild(textnode);
        document.getElementById('mob').appendChild(node);
